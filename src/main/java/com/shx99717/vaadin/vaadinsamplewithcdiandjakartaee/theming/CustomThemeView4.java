...
/**
 * Visit directly by http://localhost:8080/theme7
 * Reference a theme at another jar, the corresponding jar has been added to the pom.xml
 * We are also able to refer to the css at frontend folder
 */
@Route("theme7")
//@CssImport(value = "./style-library/cool-text-field.css", themeFor = "vaadin-text-field")
//@CssImport("./general-styles.css")
public class CustomThemeView4 extends VerticalLayout {
    ...
    private void addSomeBasic() {
        ...
        /**
         * The button locates deeply inside the vertical layout can be still styled by the
         * global css as long as it is not the part inside the shadow-root
         * check the general-styles.css
         */
        VerticalLayout v1 = new VerticalLayout();
        VerticalLayout v2 = new VerticalLayout();
        v1.add(v2);
        Button button2 = new Button("The button inside several layers of VerticalLayout");
        v2.add(button2);
        add(v1);
